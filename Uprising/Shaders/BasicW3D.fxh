...
//#define SUPPORT_CRUSHED // enable crushed vertex shader for infantry that die from Yuriko's special ability
		...
		uniform bool isFrozenPass)		
{
	...
	CalculatePositionAndNormal(InSkin, numJointsPerVertex, worldPosition, worldNormal);
		...
		worldPosition += worldNormal * OpacityOverride * 3;
...
#if defined(SUPPORT_CRUSHED)
		worldPosition += ignoredWorldNormal * OpacityOverride * 3;
#endif // SUPPORT_CRUSHED
